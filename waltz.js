...
module.exports = Waltz = (function() {
  ...
  _requestAnimeFrame = (function() {
    return requestAnimationFrame || webkitRequestAnimationFrame || mozRequestAnimationFrame || msRequestAnimationFrame || oRequestAnimationFrame || function(callback) {
      return setTimeout(callback, 1000 / 60);
    };
  })();

  _cancelAnimeFrame = (function() {
    return cancelAnimationFrame || webkitCancelAnimationFrame || mozCancelAnimationFrame || msCancelAnimationFrame || oCancelAnimationFrame || function(id) {
  ...
  Waltz.prototype.start = function() {
    ...
    (frame = (function(_this) {
      return function() {
        ...
        if (last - start >= 100 - (100 - _this.options.fps) && (_this.circles != null)) {
          _this.anime();
  ...
  Waltz.prototype.events = function() {
    ...
    this.util.addEvent(this.canvas, 'mousemove', this.add);
    this.util.addEvent(this.canvas, 'touchstart', this.add);
    this.util.addEvent(this.canvas, 'touchmove', this.add);
    return this;
  };
